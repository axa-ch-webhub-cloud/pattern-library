  ...
  const template = html`
    ...
    <div class="accessory-story-content">
      ...
      <axa-text variant="size-1">
        The AXA core team provides support for users in adopting AXA's Design System. Reach out to us with the details of your project and we will do our best to provide you with tailored advice on how to reach your objectives.
      </axa-text>
      <axa-heading rank="2" variant="secondary">Support</axa-heading>
      <axa-text variant="size-2">Part of our mission is to guide AXA product teams during their digital journey with respect to our areas of competency.</axa-text>
      <div class="contact-support-visuals">
        ...
        <div class="contact-col-wrapper">
          ...
          <p class="contact-support-visuals__paragraph"><strong>You need a clarification</strong> on any of the design/code elements? Something is too vague in our guidelines or processes? Don’t hesitate to reach out to us - we are happy to help.</p>
        </div>
      </div>
      <div class="contact-support-visuals">
        <div class="contact-col-wrapper">
        ...
        <div class="contact-col-wrapper">
          ...
          <p class="contact-support-visuals__paragraph">
            ...
            to AXA brand standards? You need help and advice in adopting AXA's Design System in your project? We are here to accompany you through all of your project's phases.
          </p>
        </div>
      </div>
      <axa-heading rank="2" variant="secondary">Contact Us</axa-heading>
      <axa-text variant="size-1">
        For any questions or feedback — don’t hesitate to be in touch via the channel that suits you best.
      </axa-text>
      <div class="contact-grid">
        <div>
          ...
          <axa-link href="https://github.com/axa-ch/patterns-library/issues">Go to GitHub</axa-link>
        </div>
        <div>
          ...
          <axa-link href="mailto:martin.stuedle@axa-winterthur.ch">Message our product owner</axa-link>
        </div>
        <div>
          ...
          <axa-link href="https://axa-ch.slack.com/messages/patterns-lib-devs/">Go to Slack</axa-link>
        </div>
        <div>
          <img src="email.svg" width="40" alt="Email Icon" />
          ...
          <axa-link href="mailto:interactiondesign@axa.ch">Email the design team</axa-link>
        </div>
      </div>
    </div>
  `;
