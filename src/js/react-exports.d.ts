...
export const AXAHeaderMobileLanguages: React.ComponentClass<
  AXAHeaderMobileLanguagesProps
>;

import { Props as AXAHeaderMobileNavigationProps } from "../components/m-header-mobile-navigation";
export const AXAHeaderMobileNavigation: React.ComponentClass<
  AXAHeaderMobileNavigationProps
>;

import { Props as AXAHeaderMobileOthersProps } from "../components/m-header-mobile-others";
export const AXAHeaderMobileOthers: React.ComponentClass<
  AXAHeaderMobileOthersProps
>;

import { Props as AXAHeaderNavigationProps } from "../components/m-header-navigation";
export const AXAHeaderNavigation: React.ComponentClass<
  AXAHeaderNavigationProps
>;
...
export const AXAHeaderTopContentBar: React.ComponentClass<
  AXAHeaderTopContentBarProps
>;
...
export const AXAPolicyFeatureItem: React.ComponentClass<
  AXAPolicyFeatureItemProps
>;
