    ...
    const template = html`
      <form id="input-demo-form" @submit="${handleSubmit}">
        ...
        <legend>input text types - work in forms</legend>
            <axa-input-text id="default" required label="Default Label" name="default"></axa-input-text>
            <axa-input-text id="email"required type="email" name="email" label="Email Label"></axa-input-text>
            <axa-input-text id="password" required label="Password Label" name="password" type="password"></axa-input-text>
