...
fixture('Title secondary - basic functionality')
  .page(`${host}/iframe.html?id=atoms-title-secondary--title-secondary&knob-variant=size-2`)
  .beforeEach(async t => {
    await t.resizeWindow(380, 680);
  });
...
fixture('Title secondary - basic functionality')
  .page(`${host}/iframe.html?id=atoms-title-secondary--title-secondary&knob-variant=size-3`)
  .beforeEach(async t => {
    await t.resizeWindow(380, 680);
  });
...
fixture('Title secondary - basic functionality')
  .page(`${host}/iframe.html?id=atoms-title-secondary--title-secondary&knob-variant=size-4`)
  .beforeEach(async t => {
    await t.resizeWindow(380, 680);
  });
...
fixture('Title secondary - basic functionality')
  .page(`${host}/iframe.html?id=atoms-title-secondary--title-secondary&knob-variant=size-5`)
  .beforeEach(async t => {
    await t.resizeWindow(380, 680);
  });
...
fixture('Title secondary - basic functionality')
  .page(`${host}/iframe.html?id=atoms-title-secondary--title-secondary&knob-variant=size-6`)
  .beforeEach(async t => {
    await t.resizeWindow(380, 680);
  });
