...
export const Fieldset = () => {
  ...
  const radioElement = html`
    <axa-checkbox label="I agree to conditions of data protection." error="Please accept our terms and conditions."></axa-checkbox>
    <axa-checkbox label="I accept the conditions"></axa-checkbox>
    <axa-checkbox label="I want to sign up for the newsletter" checked disabled></axa-checkbox>
  `;
  ...
  const template = html`
    ...
    ${horizontal
      ? html`
          <axa-fieldset horizontal="${horizontal}" error="${error}">${radioElement}</axa-fieldset>
        `
      : html`
