...
fixture('Button Link - basic functionality').page(`${host}/iframe.html?id=components-button-link--button-link`);
...
fixture('Button Link - set properties').page(`${host}/iframe.html?id=components-button-link--button-link`);
...
fixture('Button Link - icon').page(`${host}/iframe.html?id=examples-button-link-pure-html--icon-visible`);
...
fixture('Button Link - clickable').page(`${host}/iframe.html?id=examples-button-link-pure-html--clickable`);
