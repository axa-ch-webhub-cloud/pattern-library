...
fixture('Button Link - basic functionality').page(
  `${host}/iframe.html?id=components-button-link--button-link&viewMode=story`
);
...
fixture('Button Link - icon').page(
  `${host}/iframe.html?id=examples-button-link-pure-html--icon-visible&viewMode=story`
);
...
fixture('Button Link - clickable').page(
  `${host}/iframe.html?id=examples-button-link-pure-html--clickable&viewMode=story`
);
