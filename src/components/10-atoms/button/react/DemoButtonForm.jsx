  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <p>I&apos;m type submit Button in a form, on click I stop submit event for you for example you can validate me</p>
        <AXAButton type="submit">Click me I prevent submit</AXAButton>
      </form>

      <form onSubmit={handleSubmitAndChangeText}>
        <p>I&apos;m type submit Button in a form, on click I stop submit event for you and change my child label text</p>
      ...
      <form>
        <p>I&apos;m type reset Button in a form, if you type something - on click I should reset the input</p>
        <input type="text" />
