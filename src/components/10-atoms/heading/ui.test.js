...
fixture('Heading - Correct CSS attributes')
  .page(`${host}/iframe.html?id=components--heading&knob-Rank=1`)
  .afterEach(async t => {
...
fixture('Heading - Correct CSS attributes')
  .page(`${host}/iframe.html?id=components--heading&knob-Rank=2`)
  .afterEach(async t => {
    await t.maximizeWindow();
  });
...
fixture('Heading - Correct CSS attributes')
  .page(`${host}/iframe.html?id=components--heading&knob-Rank=3`)
  .afterEach(async t => {
    await t.maximizeWindow();
  });
...
fixture('Heading - Correct CSS attributes')
  .page(`${host}/iframe.html?id=components--heading&knob-Rank=4`)
  .afterEach(async t => {
    await t.maximizeWindow();
  });
...
fixture('Heading - Correct CSS attributes')
  .page(`${host}/iframe.html?id=components--heading&knob-Rank=5`)
  .afterEach(async t => {
    await t.maximizeWindow();
  });
...
fixture('Heading - Correct CSS attributes')
  .page(`${host}/iframe.html?id=components--heading&knob-Rank=6`)
  .afterEach(async t => {
    await t.maximizeWindow();
  });
...
fixture('Heading - Correct CSS attributes')
  .page(
    `${host}/iframe.html?id=components--heading&knob-Rank=1&knob-Secondary%20(variant)=true`
  )
  .afterEach(async t => {
    await t.maximizeWindow();
  });
...
fixture('Heading - Correct CSS attributes')
  .page(
    `${host}/iframe.html?id=components--heading&knob-Rank=2&knob-Secondary%20(variant)=true`
  )
  .afterEach(async t => {
    await t.maximizeWindow();
  });
...
fixture('Heading - Correct CSS attributes')
  .page(
    `${host}/iframe.html?id=components--heading&knob-Rank=3&knob-Secondary%20(variant)=true`
  )
  .afterEach(async t => {
    await t.maximizeWindow();
  });
...
fixture('Heading - Correct CSS attributes')
  .page(
    `${host}/iframe.html?id=components--heading&knob-Rank=4&knob-Secondary%20(variant)=true`
  )
  .afterEach(async t => {
    await t.maximizeWindow();
  });
...
fixture('Heading - Correct CSS attributes')
  .page(
    `${host}/iframe.html?id=components--heading&knob-Rank=5&knob-Secondary%20(variant)=true`
  )
  .afterEach(async t => {
    await t.maximizeWindow();
  });
...
fixture('Heading - Correct CSS attributes')
  .page(
    `${host}/iframe.html?id=components--heading&knob-Rank=6&knob-Secondary%20(variant)=true`
  )
  .afterEach(async t => {
    await t.maximizeWindow();
  });
