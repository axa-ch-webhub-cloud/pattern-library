...
fixture('Dropdown')
  .page(`${host}/iframe.html?id=components-molecules-dropdown--dropdown`)
  .afterEach(async t => {
...
fixture('Dropdown disabled').page(
  `${host}/iframe.html?id=components-molecules-dropdown--dropdown&knob-label=&knob-value=&knob-defaulttitle=Please%20Select&knob-name=&knob-error=Error%20Message&knob-disabled=true&knob-data-test-id=&knob-max-height=`
);
...
fixture('Dropdown check mark').page(
  `${host}/iframe.html?id=components-molecules-dropdown--dropdown&knob-checkmark=true`
);
...
fixture('Dropdown error').page(
  `${host}/iframe.html?id=components-molecules-dropdown--dropdown&knob-invalid=true&knob-error=error`
);
...
fixture('Dropdown React').page(
  `${host}/iframe.html?id=components-molecules-dropdown-react-demos--dropdown-as-react-component`
);
...
fixture('Dropdown React uncontrolled').page(
  `${host}/iframe.html?id=components-molecules-dropdown-react--dropdown-as-uncontrolled-react-component`
);
...
fixture('Dropdown React uncontrolled').page(
  `${host}/iframe.html?id=components-molecules-dropdown-react-demos--focussable-react-ified-dropdown`
);
...
fixture('Dropdown Form').page(
  `${host}/iframe.html?id=components-molecules-dropdown-demos--dropdown-inside-form`
);
