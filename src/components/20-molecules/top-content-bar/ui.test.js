...
fixture('Top content bar - basic functionality').page(
  `${host}/iframe.html?id=molecules-top-content-bar--top-content-bar`
);
...
fixture('Top content bar - inline link').page(
  `${host}/iframe.html?id=molecules-top-content-bar--top-content-bar&knob-Text=Undefined%20flighting%20object%20detected%20in%20your%20region.%20People%20are%20paniking.%20Stay%20calm&knob-Add%20axa-link=Test`
);
