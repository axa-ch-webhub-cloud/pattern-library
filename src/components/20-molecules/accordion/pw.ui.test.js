...
async function openAccordeonDisabled() {
  await page.goto(
    `${host}/iframe.html?id=components-accordion--accordion&knob-disabled=true&knob-title=This%20is%20the%20title%20of%20the%20accordeon&knob-icon=&knob-open=true&viewMode=story`
  );
  await page.waitForSelector(tag);
}
