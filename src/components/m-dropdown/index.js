...
class AXADropdown extends BaseComponentGlobal {
  ...
  connectedCallback() {
    ...
    this.onDropdownValueClick = on(this, EVENTS.CLICK, DEFAULTS.selectClass, e => this.handleDropdownValueClick(e), {
      capture: true,
      passive: false,
    });

    this.onNativeDropdownChange = on(this, EVENTS.CHANGE, DEFAULTS.nativeSelectClass, e => this.handleDropdownNativeValueChange(e), {
      capture: true,
      passive: false,
    });
