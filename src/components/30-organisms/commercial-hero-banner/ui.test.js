...
fixture('Commercial Hero Banner - basic functionality').page(
  `${host}/iframe.html?id=components--commercial-hero-banner`
);
...
fixture('Commercial Hero Banner - Dark Mode').page(
  `${host}/iframe.html?id=components--commercial-hero-banner&knob-Variant=dark&knob-Image%20Source=https://d5cplpsrt2s33.cloudfront.net/m/24c1b33e4e8ceda1/WIDE_1440_560_X2-hero_kv_neu_kv_breit_web.jpg`
);
...
fixture('Commercial Hero Banner - Content')
  .page(
    `${host}/iframe.html?id=components--commercial-hero-banner&knob-Variant=light&knob-Image%20Source=https://d5cplpsrt2s33.cloudfront.net/m/24c1b33e4e8ceda1/WIDE_1440_560_X2-hero_kv_neu_kv_breit_web.jpg`
  )
  .beforeEach(async t => {
