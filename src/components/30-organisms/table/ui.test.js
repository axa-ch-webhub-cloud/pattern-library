...
fixture('Table - basic functionality')
  .page(`${host}/iframe.html?id=organisms-table--table`)
  .beforeEach(async t => {
...
fixture('Table - maxheight functionality').page(
  `${host}/iframe.html?id=organisms-table--table&knob-innerscroll=600&knob-maxheight=160`
);
...
fixture('Table - innerscroll functionality').page(
  `${host}/iframe.html?id=organisms-table--table&knob-innerscroll=500`
);
