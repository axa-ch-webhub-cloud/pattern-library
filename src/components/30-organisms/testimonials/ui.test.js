...
fixture('Testimonials - basic functionality').page(
  `${host}/iframe.html?id=components-organisms-testimonials--testimonials`
);
...
fixture('Testimonials - attribute showallinline is set').page(
  `${host}/iframe.html?id=components-organisms-testimonials--testimonials&knob-title=Customer Reviews&knob-Text=AXA works hard to provide the best service possible to its customers.&knob-autorotatedisabled=&knob-autorotatetime=5000&knob-keysenabled=true&knob-showallinline=true`
);
