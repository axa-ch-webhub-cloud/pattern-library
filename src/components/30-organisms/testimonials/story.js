...
export const Testimonials = () => {
  ...
  const template = html`
    <axa-testimonials autorotatetime="${autorotatetime}" ?autorotatedisabled="${autorotatedisabled}" ?keysenabled="${keysenabled}" ?showallinline="${showallinline}" title="${title}" subtitle="${subtitle}">
      ...
      <span class="o-testimonials__vertical-margin">This is a small text without an author.</span>
    </axa-testimonials>
  `;
