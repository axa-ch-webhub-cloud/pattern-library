...
export default function ({ title, items, short }, childrenFragment, wcNode) {
  return html`<aside class="m-footer-languages__box">
    ...
    <ul class="m-footer-languages__list">
      ${Array.isArray(items) && items.map(({ name, code = 'en', url = '', isActive }, index) => html`
        <li class="m-footer-languages__list-item" id="${getNodeId(wcNode, code, index)}">
