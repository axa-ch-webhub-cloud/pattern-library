...
class AXAPagination extends BaseComponentGlobal {
  static tagName = 'axa-pagination'
  ...
  connectedCallback() {
    ...
    this.className = `${this.initialClassName} o-pagination`;
...
defineOnce(AXAPagination.tagName, AXAPagination);

export default AXAPagination;
