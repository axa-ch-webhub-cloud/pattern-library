...
export default ({
  ...
  return html`
    ...
    :
      ...
      ${open ? html`<axa-m-datepicker start-month="${value ? value.getMonth() : null}" start-year="${value ? value.getFullYear() : null}" class="o-datepicker__calender js-datepicker__calender" locale="${locale}" button-ok="ok" button-cancel="abbrechen"></axa-m-datepicker>` : ''}
    </article>
  `;
};
