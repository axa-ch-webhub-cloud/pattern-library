...
*At the moment, we only use Proposed Standard Custom Element.*
...
Then, you can add the component of your choice simply by importing the index.js in the `/dist/components/**` folder! Styles, HTML and JS will be all in one file! See example below:
