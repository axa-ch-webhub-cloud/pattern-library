    ...
    <div>
      <Layout withCallToAction>
        ...
        <Container>
          ...
          <p>
            Publico Headline is the first official serif typeface at AXA.
            Coupled with Source Sans Pro it enhances the design by adding rythm,
            creating a clear hierarchy and providing a strong visual identity.
          </p>
          ...
          <p>
            ...
            transition from ITC Franklin Gothic and Metric as it works pretty
            well in all user interfaces, covers a large spectrum of signs and
            has no cost.
          </p>
          <div className="Overview-shadow">
            <div className="ShadowBox shadow-lg">
        ...
        <Container background="bg-neutral-200">
          ...
          <p>
            ...
            Commercial Typeface Foundry website. Please note that you only need
            to purchase the 'bold' style. Get in touch with your entity's Brand
        ...
        <Container>
          ...
          <p>
            Please use the guidelines below in order to help you quickly
            identify the correct CSS to be applied to your headings.
          </p>
          <Tabs>
            <TabList>
              <Tab>Font size</Tab>
        ...
        <Container background="bg-neutral-200">
          ...
          <p>
            The AXA Digital Guidelines are a set of rules and advice on how to
            use the full range of design assets in your digital project.
          </p>
