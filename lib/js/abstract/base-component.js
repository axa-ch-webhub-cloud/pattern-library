...
var BaseComponent = function (_CustomElement2) {
  babelHelpers.inherits(BaseComponent, _CustomElement2);
  ...
  function BaseComponent() {
    ...
    var _this = babelHelpers.possibleConstructorReturn(this, (BaseComponent.__proto__ || Object.getPrototypeOf(BaseComponent)).call(this));
    ...
    _this._reduceProps = function (_ref, key) {
      ...
      if (hasKey) {
        babelHelpers.set(BaseComponent.prototype.__proto__ || Object.getPrototypeOf(BaseComponent.prototype), key, value, _this);
      }
    ...
    if (Array.isArray(observedAttributes)) {
      observedAttributes.forEach(function (attr) {
        ...
        Object.defineProperty(_this, key, _obj = {
          get: function get() {
            return this['_' + key];
          },
          set: function set(value) {
            ...
            if (hasKey) {
              babelHelpers.set(_obj.__proto__ || Object.getPrototypeOf(_obj), key, value, this);
            }
  ...
  babelHelpers.createClass(BaseComponent, [{
        ...
        if (Array.isArray(observedAttributes)) {
          ...
          observedAttributes.forEach(function (attr) {
            ...
            if (_this2.hasAttribute(attr)) {
              ...
              if (hasKey) {
                babelHelpers.set(BaseComponent.prototype.__proto__ || Object.getPrototypeOf(BaseComponent.prototype), key, value, _this2);
              }
            }
          });
    ...
    value: function render() {
      ...
      if (this._hasTemplate) {
        ...
        try {
          ...
          if (initial) {
            babelHelpers.get(BaseComponent.prototype.__proto__ || Object.getPrototypeOf(BaseComponent.prototype), 'appendChild', this).call(this, renderFragment);
          } else {
    ...
    value: function appendChild(node) {
      if (this._isMorphing || !this._hasTemplate || !this._hasRendered) {
        babelHelpers.get(BaseComponent.prototype.__proto__ || Object.getPrototypeOf(BaseComponent.prototype), 'appendChild', this).call(this, node);
        return;
      }
    ...
    set: function set(text) {
      if (!this._hasTemplate || !this._hasRendered) {
        babelHelpers.set(BaseComponent.prototype.__proto__ || Object.getPrototypeOf(BaseComponent.prototype), 'innerText', text, this);
        return;
      }
    ...
    set: function set(text) {
      if (!this._hasTemplate || !this._hasRendered) {
        babelHelpers.set(BaseComponent.prototype.__proto__ || Object.getPrototypeOf(BaseComponent.prototype), 'textContent', text, this);
        return;
      }
    ...
    set: function set(html) {
      if (!this._hasTemplate || !this._hasRendered) {
        babelHelpers.set(BaseComponent.prototype.__proto__ || Object.getPrototypeOf(BaseComponent.prototype), 'innerHTML', html, this);
        return;
      }
