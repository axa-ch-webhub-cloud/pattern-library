...
var AXAHeaderMetaRight = function (_BaseComponentGlobal) {
  ...
  function AXAHeaderMetaRight() {
    ...
    return _possibleConstructorReturn(this, (AXAHeaderMetaRight.__proto__ || _Object$getPrototypeOf(AXAHeaderMetaRight)).call(this, { styles: styles, template: template }));
  }
