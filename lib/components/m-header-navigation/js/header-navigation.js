...
var HeaderNavigation = function (_UiEvents) {
  _inherits(HeaderNavigation, _UiEvents);
  ...
  function HeaderNavigation(wcNode) {
    ...
    var _this = _possibleConstructorReturn(this, (HeaderNavigation.__proto__ || _Object$getPrototypeOf(HeaderNavigation)).call(this, wcNode, {
    ...
    _this.wcNode = wcNode;
    _this.options = _extends({}, HeaderNavigation.DEFAULTS, {
  ...
  _createClass(HeaderNavigation, [{
    ...
    value: function destroy() {
      _get(HeaderNavigation.prototype.__proto__ || _Object$getPrototypeOf(HeaderNavigation.prototype), 'destroy', this).call(this);
