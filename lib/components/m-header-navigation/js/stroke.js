...
var Stroke = function (_UiEvents) {
  ...
  function Stroke(wcNode) {
    ...
    var _this = _possibleConstructorReturn(this, (Stroke.__proto__ || _Object$getPrototypeOf(Stroke)).call(this, wcNode, {
    ...
    _this.wcNode = wcNode;
    _this.options = _extends({}, Stroke.DEFAULTS, options);
  ...
  _createClass(Stroke, [{
    ...
    value: function destroy() {
      _get(Stroke.prototype.__proto__ || _Object$getPrototypeOf(Stroke.prototype), 'destroy', this).call(this);
