...
var DropDown = function (_UiEvents) {
  _inherits(DropDown, _UiEvents);

  function DropDown(wcNode, options) {
    _classCallCheck(this, DropDown);

    // eslint-disable-next-line no-param-reassign
    options = _extends({}, DropDown.DEFAULTS, options);

    var _this = _possibleConstructorReturn(this, (DropDown.__proto__ || _Object$getPrototypeOf(DropDown)).call(this, wcNode, options));
  ...
  _createClass(DropDown, [{
    ...
    value: function destroy() {
      _get(DropDown.prototype.__proto__ || _Object$getPrototypeOf(DropDown.prototype), 'destroy', this).call(this);
