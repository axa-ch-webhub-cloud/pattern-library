...
var FormGroup = function (_UiEvents) {
  _inherits(FormGroup, _UiEvents);

  function FormGroup(wcNode, options) {
    _classCallCheck(this, FormGroup);

    // eslint-disable-next-line no-param-reassign
    options = _extends({}, FormGroup.DEFAULTS, options);

    var _this = _possibleConstructorReturn(this, (FormGroup.__proto__ || _Object$getPrototypeOf(FormGroup)).call(this, wcNode, options));
  ...
  _createClass(FormGroup, [{
    ...
    value: function destroy() {
      _get(FormGroup.prototype.__proto__ || _Object$getPrototypeOf(FormGroup.prototype), 'destroy', this).call(this);
