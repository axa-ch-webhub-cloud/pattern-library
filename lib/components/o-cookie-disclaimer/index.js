...
var AXACookieDisclaimer = function (_BaseComponentGlobal) {
  ...
  function AXACookieDisclaimer() {
    ...
    var _this = _possibleConstructorReturn(this, (AXACookieDisclaimer.__proto__ || _Object$getPrototypeOf(AXACookieDisclaimer)).call(this, { styles: styles, template: template }));
