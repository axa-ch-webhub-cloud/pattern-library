...
export default (function () {
  ...
  return _svg = document.createElementNS(_svgNamespace, 'svg'), _svg.setAttribute('class', '' + String(classes) + ''), _appendChild(_svg, ['\n    ', (_use = document.createElementNS(_svgNamespace, 'use'), _use.setAttributeNS(_xlinkNamespace, 'xlink:href', '#src--assets--icons--' + String(icon) + ''), _use.setAttribute('href', '#src--assets--icons--' + String(icon) + ''), _use), '\n  ']), _svg;
});