...
export default (function (_ref, childrenFragment) {
  ...
  var headerPrimaryClasses = classnames('m-accordion-item__heading', 'm-accordion-item__heading--primary', (_classnames = {}, babelHelpers.defineProperty(_classnames, 'm-accordion-item__heading--' + headerColor, headerColor), babelHelpers.defineProperty(_classnames, 'm-accordion-item__heading--with-secondary', headerSecondary), _classnames));
