...
var AccordionItem = function (_UiEvents) {
  _inherits(AccordionItem, _UiEvents);

  function AccordionItem(wcNode, options) {
    _classCallCheck(this, AccordionItem);

    // eslint-disable-next-line no-param-reassign
    options = _extends({}, AccordionItem.DEFAULTS, options);

    var _this = _possibleConstructorReturn(this, (AccordionItem.__proto__ || _Object$getPrototypeOf(AccordionItem)).call(this, wcNode, options));
  ...
  _createClass(AccordionItem, [{
    ...
    value: function destroy() {
      _get(AccordionItem.prototype.__proto__ || _Object$getPrototypeOf(AccordionItem.prototype), 'destroy', this).call(this);
