...
var HeaderMobileNavigation = function () {
  function HeaderMobileNavigation(wcNode, options) {
    ...
    babelHelpers.classCallCheck(this, HeaderMobileNavigation);
    ...
    this.wcNode = wcNode;
    this.options = babelHelpers.extends({}, HeaderMobileNavigation.DEFAULTS, options);
  ...
  babelHelpers.createClass(HeaderMobileNavigation, [{
    key: 'init',
    value: function init() {
