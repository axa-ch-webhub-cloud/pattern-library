...
var AXAHeaderMobileNavigation = function (_BaseComponentGlobal) {
  ...
  function AXAHeaderMobileNavigation() {
    ...
    var _this = _possibleConstructorReturn(this, (AXAHeaderMobileNavigation.__proto__ || _Object$getPrototypeOf(AXAHeaderMobileNavigation)).call(this, styles, template));
