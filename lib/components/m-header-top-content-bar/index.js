...
var AXAHeaderTopContentBar = function (_BaseComponentGlobal) {
  ...
  function AXAHeaderTopContentBar() {
    ...
    return _possibleConstructorReturn(this, (AXAHeaderTopContentBar.__proto__ || _Object$getPrototypeOf(AXAHeaderTopContentBar)).call(this, { styles: styles, template: template }));
  }
