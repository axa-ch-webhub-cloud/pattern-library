...
var AXAStickyContainer = function (_BaseComponentGlobal) {
  ...
  function AXAStickyContainer() {
    ...
    var _this = _possibleConstructorReturn(this, (AXAStickyContainer.__proto__ || _Object$getPrototypeOf(AXAStickyContainer)).call(this, stylesStickyContainer));
...
var AXASticky = function (_BaseComponentGlobal2) {
  ...
  function AXASticky() {
    ...
    var _this2 = _possibleConstructorReturn(this, (AXASticky.__proto__ || _Object$getPrototypeOf(AXASticky)).call(this, stylesSticky, templateSticky));
