...
export default function (_ref, childrenFragment) {
  ...
  var buttonClasses = classnames('m-button', 'js-button', classes, (_classnames = {}, _defineProperty(_classnames, 'm-button--' + color, color), _defineProperty(_classnames, 'm-button--' + size, size), _defineProperty(_classnames, 'm-button--ghost', ghost), _defineProperty(_classnames, 'm-button--motion', motion), _defineProperty(_classnames, 'm-button--gpu', gpu), _defineProperty(_classnames, 'm-button--arrow', arrow), _defineProperty(_classnames, 'm-button--generic-icon', icon && !arrow), _classnames));
